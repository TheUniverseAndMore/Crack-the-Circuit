...
TutorialManager.prototype.constructor = Menu;
        ...
        case 3:
            ...
            switch(this.subtutShowing) {
                case 2:
                    ...
                    this.tutText2 = this.game.add.text(this.game.world.centerX,0.79*this.game.world.height, "See how it affects the\nother bulbs in the circuit", { font: "Quicksand", fontSize: 44, fill: "#ffffff", align: "center" } );
                    this.tutText2.clearColors();
                    this.tutText2.anchor.setTo(0.5);
