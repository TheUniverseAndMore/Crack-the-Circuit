...
Menu.prototype.createSoundMusicBtns = function() {
    var soundBtnString;
    if(this.soundOn) { soundBtnString = 'sound_btn'; } else { soundBtnString = 'sound_btn_x'; }
    this.soundBtn = this.game.add.sprite(0.03*this.game.world.width, 0.96*this.game.world.height,'spriteSheetMenu',soundBtnString);
    this.soundBtn.anchor.setTo(0.5);
    this.soundBtn.customParams = { btnIndex:CrackTheCircuit.BTN_INDEX_SOUND, spriteString:soundBtnString};

//    var musicBtnString;
//    if(this.musicOn) { musicBtnString = 'music_btn_x'; } else { musicBtnString = 'music_btn'; }
//    this.musicBtn = this.game.add.sprite(0.1*this.game.world.width, 0.95*this.game.world.height,'spriteSheetMenu',musicBtnString);
//    this.musicBtn.anchor.setTo(0.5);
//    this.musicBtn.customParams = { btnIndex:CrackTheCircuit.BTN_INDEX_MUSIC, spriteString:musicBtnString};
    
    this.soundBtn.alpha = 0.5;
    //this.musicBtn.alpha = 0.7;
    
    this.soundBtn.scale.setTo(0.4);
    //this.musicBtn.scale.setTo(0.5);

    this.soundBtn.events.onInputOver.add(this.btnOnOver, this);
    this.soundBtn.events.onInputOut.add(this.btnOnOut, this);
    this.soundBtn.events.onInputDown.add(this.btnOnDown, this);
    this.soundBtn.events.onInputUp.add(this.btnOnUp, this);
    
//    this.musicBtn.events.onInputOver.add(this.btnOnOver, this);
//    this.musicBtn.events.onInputOut.add(this.btnOnOut, this);
//    this.musicBtn.events.onInputDown.add(this.btnOnDown, this);
//    this.musicBtn.events.onInputUp.add(this.btnOnUp, this);
    
    this.soundBtn.inputEnabled = true;
    //this.musicBtn.inputEnabled = true;
};

//Menu.prototype.fadeInSoundMusicBtns = function() {
...
Menu.prototype.btnOnOut = function(sprite,pointer) {
    ...
    if(!(this.gameState.gameState == CrackTheCircuit.STATE_GAME && this.gameState.blueprint && this.gameState.blueprint.isDraggingComponent)) {
...
Menu.prototype.btnOnUp = function(sprite,pointer,isOver) {
    ...
    if(isOver && sprite.visible) { 
        ...
        if(sprite.customParams.btnIndex == CrackTheCircuit.BTN_INDEX_MUSIC) {
            ...
            if(this.soundOn) { sprite.customParams.spriteString = 'sound_btn'; } else { sprite.customParams.spriteString = 'sound_btn_x'; }
        } 
    }
};
...
Menu.prototype.buttonPressed = function(btnIndex) {
    switch(btnIndex) {
        ...
        case CrackTheCircuit.BTN_INDEX_FULL_SCREEN_X:
            ...
            break;
        case CrackTheCircuit.BTN_INDEX_SHORT_HELP:
            this.showShortHelp();
            break;
    }
};
...
Menu.prototype.createShortHelpBtn = function() {
    this.shortHelpBtn = this.game.add.sprite(0,0,'spriteSheetMenu','shortHelp_btn');
    this.shortHelpBtn.customParams = { btnIndex:CrackTheCircuit.BTN_INDEX_SHORT_HELP, spriteString:'shortHelp_btn', isText: false};

    this.shortHelpBtn.visible = false;
    this.shortHelpBtn.anchor.setTo(0.5);
    this.shortHelpBtn.scale.setTo(0.9);
    this.shortHelpBtn.position = {x:this.game.world.width - 0.5*this.shortHelpBtn.width - 10, y: this.game.world.height-0.5*this.shortHelpBtn.height-8};

    this.shortHelpBtn.events.onInputOver.add(this.btnOnOver, this);
    this.shortHelpBtn.events.onInputOut.add(this.btnOnOut, this);
    this.shortHelpBtn.events.onInputDown.add(this.btnOnDown, this);
    this.shortHelpBtn.events.onInputUp.add(this.btnOnUp, this);
};

Menu.prototype.showShortHelpBtn = function() {
    if(!this.shortHelpBtn) { this.createShortHelpBtn(); }
    this.shortHelpBtn.visible = true;
    this.shortHelpBtn.inputEnabled = true;
};

Menu.prototype.hideShortHelpBtn = function() {
    this.shortHelpBtn.visible = false;
    this.shortHelpBtn.inputEnabled = false;
    this.gameState.blueprint.shortHelpBtnShowing = false;
};

Menu.prototype.showShortHelp = function() {
    this.shortHelpBtn.inputEnabled = false;
    this.shortHelpBtn.alpha = 0.6;
};
...
Menu.prototype.nextLevelBlockPressed = function() {
    ...
    var moveTween = this.game.add.tween(this.levelBoxBtnGroup).to({x:this.levelBoxBtnGroup.targetX},400,Phaser.Easing.Back.Out, true);
...
//    showElectronsBtn.customParams = { btnIndex:CrackTheCircuit.BTN_INDEX_ELECTRONS, spriteString:showElectronsBtnString};
    ...
    var clearDataBtn = this.settingsBtnGroup.create(0,0*this.game.world.height,'spriteSheetMenu','resetDataBtn');
