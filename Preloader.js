...
CrackTheCircuit.Preloader.prototype = {
    ...
    preload: function()  {
        ...
        this.load.audio('bgMusic', ['assets/audio/Music/bgMusic.mp3', 'assets/audio/Music/bgMusic.ogg']);
        ...
        //scripts
        this.load.script('GameState.js', 'GameState.js'); //load the game
        this.load.script('Menu.js', 'Menu.js'); //load the menu
        this.load.script('Background.js', 'Background.js'); //load the background
        this.load.script('CircuitBox.js', 'CircuitBox.js'); //load the circuit box
